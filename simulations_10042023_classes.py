...
class Simulation:
    ...
    def recursion(self):
        ...
        negative_interval = 0
        positive_interval = 0
        while t < self.stop_time or np.abs(d) > 2:# or not self.all_segregating_extinct:
            ...
            # if t > 5000 and not self.all_segregating_extinct:
            #    self.check_all_segregating_extinct()
